          ...
          <div className="flex flex-col xl:flex-col flex-1 px-4 gap-5">
            ...
            <div className="flex flex-col flex-1 pb-2">
                ...
                >
                  ...
                  <div className="pt-5">
                    ...
                    <div className="text-black w-full text-left mb-3">
                      ...
                      <h2 className="text-xl font-bold">{valUser.firstname + ' ' + valUser.lastname}</h2>
                    </div>
                    <div className="flex justify-center px-2 bg-gradient-to-b from-[#45E1FF] to-black relative rounded-xl p-2">
                      <div className="flex flex-col items-center">
                        <div className="max-w-[300px] px-10 md:px-20 md:max-w-[400px]">
                          <img src={FreeEntries} alt="" className="w-full h-full object-contain" />
                        </div>
                      ...
                      {giveawaysPast
                        ...
                        .map((giveaway, key) => (
                          <DashboardVehicleCard
                            ...
                            raffleimage={giveaway.raffle?.raffleimage}
                            eligeble={false}
                            winningNumber={(giveaway.winningNumber && giveaway.winningNumber !== '0') ? giveaway.winningNumber : 'Reveal Soon'}
                            ...
                            winner={giveaway.winner ? (giveaway.winner?.firstname ? giveaway.winner?.firstname : 'N/A') + ' ' + (giveaway.winner?.lastname ? giveaway.winner.lastname[0] : 'N/A') : 'Reveal Soon'}
                            status={0}
              ...
              <div className="hidden xl:flex flex-col space-y-4 items-end">
                ...
                // }}
                >
                  <div className="bg-gray-400 w-1/3 flex items-center justify-start p-4 rounded-xl"
                    style={{
                  ...
                  <div className="flex justify-center flex-col items-center px-32 bg-gradient-to-b h-full -translate-y-4 from-[#45E1FF] to-black w-2/3 relative rounded-xl">
                    <h1 className="text-white uppercase text-4xl font-bold">WANT MORE CHANCES?</h1>
                    <div className="w-full p-5">
                      <img src={FreeEntries} className="w-full h-full object-contain" />
                    </div>
                      ...
                      {giveawaysPast
                        ...
                        .map((giveaway, key) => (
                          <DashboardVehicleCard
                            ...
                            oneOffPackage={giveaway.raffle?.name === "Vehicle" ? true : false}
                            // winner={giveaway?.endtime === "2024-01-14T01:00:00.001Z" ? "Ramesh F" : giveaway?.endtime === "2024-01-21T01:00:00.001Z" ? "Joshua S" : "Joshua A"}
                            winner={giveaway.winner ? (giveaway.winner?.firstname ? giveaway.winner?.firstname : 'Reveal') + ' ' + (giveaway.winner?.lastname ? giveaway.winner.lastname[0] : 'Soon') : 'Reveal Soon'}
                            status={0}
                          // winner={giveaway[0] ? "ramesh fonseka" : giveaway[1] === "Joshua Stephans" ? giveaway[2] === "Joshua a" : }
                          // onButton={() => {
                          //   handleButton({
